...
export function WhatsAppButton() {
    const phoneNumber = "212613022325";
    const message = encodeURIComponent("Bonjour! Je suis intéressé par vos services LLC.");
    ...
    return (
        <motion.a
            ...
            transition={{ delay: 2, duration: 0.5, ease: [0.4, 0, 0.2, 1] }}
